...
namespace Lacos.GestioneCommesse.Dal.Migrations
{
    ...
    [Migration("20260707090250_Add_Flag_IsDefaultApolloActivityMessageOperator")]
    partial class Add_Flag_IsDefaultApolloActivityMessageOperator
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ActivityActivity", b =>
                {
                    b.Property<long>("ActivityDependenciesId")
                        .HasColumnType("bigint");

                    b.Property<long>("ParentActivitiesId")
                        .HasColumnType("bigint");

                    b.HasKey("ActivityDependenciesId", "ParentActivitiesId");

                    b.HasIndex("ParentActivitiesId");

                    b.ToTable("ActivityDependencies", "Docs");
                });

            modelBuilder.Entity("ActivityPurchaseOrder", b =>
                {
                    b.Property<long>("ParentActivitiesId")
                        .HasColumnType("bigint");

                    b.Property<long>("PurchaseOrderDependenciesId")
                        .HasColumnType("bigint");

                    b.HasKey("ParentActivitiesId", "PurchaseOrderDependenciesId");

                    b.HasIndex("PurchaseOrderDependenciesId");

                    b.ToTable("PurchaseOrderDependencies", "Docs");
                });
            ...
            modelBuilder.Entity("JobPurchaseOrder", b =>
                {
                    ...
                    b.HasKey("JobsId", "PurchaseOrdersId");
            ...
            modelBuilder.Entity("Lacos.GestioneCommesse.Domain.Docs.Activity", b =>
                {
                    ...
                    b.Property<bool?>("IncludeMaintenanceCosts")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool?>("IsFloorDelivery")
                        .HasColumnType("bit");

                    b.Property<bool?>("IsMandatoryExpiration")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Lacos.GestioneCommesse.Domain.Docs.InterventionProductCheckListItemKO", b =>
                {
                    b.Property<long>("ActivityId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("OutcomeCorrectiveAction")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToView("v_CheckListItems_KoOutcome", "Docs");
                });
            ...
            modelBuilder.Entity("Lacos.GestioneCommesse.Domain.Docs.Job", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("MandatoryDate")
                        .HasPrecision(3)
                        .HasColumnType("datetimeoffset(3)");
                    ...
                    b.Property<string>("SharepointFolder")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Lacos.GestioneCommesse.Domain.Docs.JobAccounting", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("AccountingTypeId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Lacos.GestioneCommesse.Domain.Docs.JobsProgressStatus", b =>
                {
                    b.Property<int?>("Activities_completed")
                        .HasColumnType("int");

                    b.Property<int?>("Activities_list")
                        .HasColumnType("int");

                    b.Property<decimal?>("Activities_progress")
                        .HasPrecision(14, 2)
                        .HasColumnType("decimal");
                    ...
                    b.Property<int?>("Interventions_completed")
                        .HasColumnType("int");

                    b.Property<int?>("Interventions_list")
                        .HasColumnType("int");

                    b.Property<decimal?>("Interventions_progress")
                        .HasPrecision(14, 2)
                        .HasColumnType("decimal");
                    ...
                    b.Property<int?>("PurchaseOrders_completed")
                        .HasColumnType("int");

                    b.Property<int?>("PurchaseOrders_list")
                        .HasColumnType("int");

                    b.Property<decimal?>("PurchaseOrders_progress")
                        .HasPrecision(14, 2)
                        .HasColumnType("decimal");

                    b.ToTable((string)null);

                    b.ToView("v_JobsProgressStatus", "Docs");
                });
            ...
            modelBuilder.Entity("Lacos.GestioneCommesse.Domain.Docs.MessagesList", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("ActivityExpirationDate")
                        .HasPrecision(3)
                        .HasColumnType("datetimeoffset(3)");
                    ...
                    b.Property<string>("SenderOperator")
                        .HasColumnType("nvarchar(max)");

                    b.Property<long?>("SenderOperatorId")
                        .HasColumnType("bigint");

                    b.Property<string>("TargetOperator")
                        .HasColumnType("nvarchar(max)");

                    b.Property<long?>("TargetOperatorId")
                        .HasColumnType("bigint");

                    b.Property<string>("TargetOperators")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Lacos.GestioneCommesse.Domain.Docs.PurchaseOrderExpense", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("PurchaseOrderExpenses", "Docs");
                });
            ...
            modelBuilder.Entity("Lacos.GestioneCommesse.Domain.Docs.PurchaseOrderSummary", b =>
                {
                    ...
                    b.ToView("v_PurchaseOrdersSummary", "Docs");
                });
            ...
            modelBuilder.Entity("Lacos.GestioneCommesse.Domain.Registry.AccountingType", b =>
                {
                    ...
                    b.ToTable("AccountingTypes", "Registry");
                });
            ...
            modelBuilder.Entity("Lacos.GestioneCommesse.Domain.Registry.ActivityType", b =>
                {
                    ...
                    b.Property<bool?>("ViewInPurchaseOrder")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Lacos.GestioneCommesse.Domain.Registry.EntityLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Lacos.GestioneCommesse.Domain.Registry.HelperDocument", b =>
                {
                    ...
                    b.ToTable("HelperDocuments", "Registry");
                });
            ...
            modelBuilder.Entity("Lacos.GestioneCommesse.Domain.Registry.NotificationOperator", b =>
                {
                    ...
                    b.ToTable("NotificationOperators", "Registry");
                });
            ...
            modelBuilder.Entity("Lacos.GestioneCommesse.Domain.Registry.Operator", b =>
                {
                    ...
                    b.Property<bool>("IsDefaultApolloActivityMessageOperator")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("ActivityActivity", b =>
                {
                    b.HasOne("Lacos.GestioneCommesse.Domain.Docs.Activity", null)
                        .WithMany()
                        .HasForeignKey("ActivityDependenciesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Lacos.GestioneCommesse.Domain.Docs.Activity", null)
                        .WithMany()
                        .HasForeignKey("ParentActivitiesId")
            ...
            modelBuilder.Entity("ActivityPurchaseOrder", b =>
                {
                    ...
                    b.HasOne("Lacos.GestioneCommesse.Domain.Docs.PurchaseOrder", null)
                        .WithMany()
                        .HasForeignKey("PurchaseOrderDependenciesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("JobPurchaseOrder", b =>
                {
                    b.HasOne("Lacos.GestioneCommesse.Domain.Docs.Job", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Lacos.GestioneCommesse.Domain.Docs.JobAccounting", b =>
                {
                    b.HasOne("Lacos.GestioneCommesse.Domain.Registry.AccountingType", "AccountingType")
                        .WithMany("JobAccountings")
            ...
            modelBuilder.Entity("Lacos.GestioneCommesse.Domain.Registry.HelperDocument", b =>
                {
                    b.HasOne("Lacos.GestioneCommesse.Domain.Registry.HelperType", "HelperType")
            ...
            modelBuilder.Entity("Lacos.GestioneCommesse.Domain.Registry.NotificationOperator", b =>
                {
                    b.HasOne("Lacos.GestioneCommesse.Domain.Registry.Operator", "Operator")
                        .WithMany("NotificationOperators")
                        .HasForeignKey("OperatorId");
            ...
            modelBuilder.Entity("Lacos.GestioneCommesse.Domain.Registry.Operator", b =>
                {
                    ...
                    b.Navigation("NotificationOperators");
                });
