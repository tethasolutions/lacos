    ...
    readonly menu: Menu = new Menu(
        [
            ...
            new DropDownMenuEntry('Commesse', [
                ...
                new MenuEntry(['/job-accountings'], 'Voci Contabili',
                    e => e.startsWith('/job-accountings'),
                    e => e.isAuthorized(Role.Administrator)
                )
            ]),
            ...
            new MenuEntry(['/products-stock-quantities'], 'Magazzino',
                e => e.startsWith('/products-stock-quantities'),
                e => e.isAuthenticated()
            ),
